...
/** Leisure activities foreigners enjoy across Sri Lanka. */
...
export const activities: Activity[] = [
  { id: "badminton", name: "Badminton", emoji: "🏸", image: actBadminton, category: "Sport", region: "Colombo & resorts", tagline: "Indoor courts & friendly local clubs", hotline: "+94 112 345 678" },
  { id: "tennis", name: "Tennis", emoji: "🎾", image: actTennis, category: "Sport", region: "Nuwara Eliya & Colombo", tagline: "Colonial-era clay & hotel courts", hotline: "+94 112 346 789" },
  { id: "surfing", name: "Surfing", emoji: "🏄", image: actSurfing, category: "Water", region: "Arugam Bay & Weligama", tagline: "World-class breaks for all levels", hotline: "+94 112 347 890" },
  { id: "snorkeling", name: "Snorkeling & Diving", emoji: "🤿", image: actSnorkeling, category: "Water", region: "Pigeon Island & Hikkaduwa", tagline: "Coral reefs, turtles & shipwrecks", hotline: "+94 112 348 901" },
  { id: "whale-watching", name: "Whale Watching", emoji: "🐋", image: actWhale, category: "Water", region: "Mirissa & Trincomalee", tagline: "Blue whales & dolphin pods", hotline: "+94 112 349 012" },
  { id: "safari", name: "Wildlife Safari", emoji: "🐘", image: actSafari, category: "Nature", region: "Yala & Udawalawe", tagline: "Leopards, elephants & jeep tours", hotline: "+94 112 350 123" },
  { id: "hiking", name: "Hiking & Trekking", emoji: "🥾", image: actHiking, category: "Adventure", region: "Ella & Knuckles", tagline: "Peaks, plains & waterfall trails", hotline: "+94 112 351 234" },
  { id: "cycling", name: "Cycling Tours", emoji: "🚴", image: actCycling, category: "Adventure", region: "Anuradhapura & Sigiriya", tagline: "Ride past ruins & paddy fields", hotline: "+94 112 352 345" },
  { id: "tea-tasting", name: "Tea Plantation Tours", emoji: "🍵", image: actTea, category: "Culture", region: "Ella & Nuwara Eliya", tagline: "Estate walks & fresh Ceylon brews", hotline: "+94 112 353 456" },
  { id: "cooking-class", name: "Cooking Classes", emoji: "🍛", image: actCooking, category: "Culture", region: "Galle & Kandy", tagline: "Master curries, hoppers & spices", hotline: "+94 112 354 567" },
  { id: "yoga", name: "Yoga & Wellness", emoji: "🧘", image: actYoga, category: "Wellness", region: "Mirissa & Hiriketiya", tagline: "Beachfront retreats & Ayurveda", hotline: "+94 112 355 678" },
  { id: "white-water", name: "White Water Rafting", emoji: "🛶", image: actWhiteWater, category: "Adventure", region: "Kitulgala", tagline: "Rapids through the rainforest", hotline: "+94 112 356 789" },
  { id: "hot-air-balloon", name: "Hot Air Ballooning", emoji: "🎈", image: actBalloon, category: "Adventure", region: "Dambulla & Sigiriya", tagline: "Sunrise flights over the plains", hotline: "+94 112 357 890" },
  { id: "golf", name: "Golf", emoji: "⛳", image: actGolf, category: "Sport", region: "Nuwara Eliya & Colombo", tagline: "Scenic highland & city courses", hotline: "+94 112 358 901" },
  { id: "kitesurfing", name: "Kitesurfing", emoji: "🪁", image: actKite, category: "Water", region: "Kalpitiya", tagline: "Steady winds & flat lagoons", hotline: "+94 112 359 012" },
  { id: "train-ride", name: "Scenic Train Rides", emoji: "🚂", image: actTrain, category: "Culture", region: "Kandy to Ella", tagline: "The world's prettiest rail journey", hotline: "+94 112 360 123" },
  { id: "stand-up-paddle", name: "Stand-Up Paddle", emoji: "🏄‍♀️", image: actPaddle, category: "Water", region: "Bentota & Weligama", tagline: "Calm rivers, lagoons & sunsets", hotline: "+94 112 361 234" },
  { id: "spa", name: "Ayurveda Spa", emoji: "💆", image: actSpa, category: "Wellness", region: "Bentota & Beruwala", tagline: "Traditional herbal treatments", hotline: "+94 112 362 345" },
];

...
export const Route = createFileRoute("/donation/success")({
  head: () => ({
    meta: [
      { title: "Thank You for Your Donation — Visit Sri Lanka" },
      {
        name: "description",
        content:
          "Your donation was successful. Thank you for supporting good causes across Sri Lanka.",
      },
    ],
  }),
    ...
    <AppShell>
      <div className="flex min-h-[70vh] flex-col items-center justify-center px-6 text-center">
        ...
        <p className="mt-2 max-w-xs text-sm text-muted-foreground">
          Thank you for your generosity. A payment receipt has been emailed to
          you. Your support helps the people and places of Sri Lanka. 🙏
        </p>
